...
public class ShiWuKLLB extends AppCompatActivity {
    ...
    private List<FoodItem> initializeStaticFoodList() {
        ...
        foods.add(new FoodItem("苹果", 52));
        foods.add(new FoodItem("香蕉", 89));
        foods.add(new FoodItem("米饭", 130));
        foods.add(new FoodItem("牛油果", 160));
        foods.add(new FoodItem("杏仁", 576));
        foods.add(new FoodItem("西兰花", 34));
        foods.add(new FoodItem("鸡胸肉", 165));
        foods.add(new FoodItem("鸡蛋", 155));
        foods.add(new FoodItem("大蒜", 149));
        foods.add(new FoodItem("葡萄", 69));
        foods.add(new FoodItem("胡萝卜", 41));
        foods.add(new FoodItem("奶酪", 402));
        foods.add(new FoodItem("樱桃", 50));
        foods.add(new FoodItem("玉米", 96));
        foods.add(new FoodItem("黄瓜", 16));
        foods.add(new FoodItem("青豆", 31));
        foods.add(new FoodItem("蜂蜜", 304));
        foods.add(new FoodItem("牛奶", 42));
        foods.add(new FoodItem("菠菜", 23));
        foods.add(new FoodItem("番茄", 18));
        foods.add(new FoodItem("土豆", 77));
        foods.add(new FoodItem("南瓜", 26));
        foods.add(new FoodItem("黑巧克力", 546));
        foods.add(new FoodItem("大豆", 446));
        foods.add(new FoodItem("草莓", 32));
        foods.add(new FoodItem("糖", 387));
        foods.add(new FoodItem("牛肉", 250));
        foods.add(new FoodItem("羊肉", 294));
        foods.add(new FoodItem("培根", 541));
        foods.add(new FoodItem("鳗鱼", 184));
        foods.add(new FoodItem("豆腐", 76));
        return foods;
    }
